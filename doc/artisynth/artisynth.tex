...
\javaclass[\mbase]{ComponentChangeEvent} for which
\javamethod[\mbase.ComponentChangeEvent]{stateChanged()}
returns {\tt true}.
...
\javamethod*[\mbase.ScanWriteUtils]{postscanReference(Deque,,)}
...
\begin{lstlisting}[]
   ...
   public boolean postscanItem (
      ...
      if (ScanWriteUtils.postscanPropertyValue (tokens, this, deferredProps)) {
         return true;
      }
      else {
...
\javamethod[maspack.util]{ClassAliases.resolveClass()}.
