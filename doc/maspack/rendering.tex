...
\else
 \includegraphics[width=5.5in]{images/coordinateFrames.idr}
\fi
\end{center}
...
\else
 \includegraphics[width=5.5in]{images/orthographic.idr}
\fi
\end{center}
...
\else
 \includegraphics[width=2.5in]{images/eyeCenterUp.idr}
\fi
\end{center}
...
\else
 \includegraphics[width=4.00in]{images/wrapping.idr}
\fi
\end{center}
