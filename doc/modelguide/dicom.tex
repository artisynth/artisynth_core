...
\begin{figure}[!ht]
   \begin{center}
      \setlengthLaTeXML{\imglength}{0.8\textwidth}{0.8\textwidth}
...
\end{itemize}
This layout is depicted in Figure \ref{fig:dicom:attribute}.
\begin{figure}[ht]
   \centering
...
\end{figure}
A list of important attributes are provided in Table \ref{tbl:dicom:attribute}.
\begin{table}[ht]
   \centering
