...
\begin{tabular}{cc}
\iflatexml
 \includegraphics[]{images/torusElemWireframeB}
 \includegraphics[]{images/torusElemWidgetsB}
\else
 \includegraphics[width=2.8in]{images/torusElemWireframeB}
 \includegraphics[width=2.8in]{images/torusElemWidgetsB}
\fi
\end{tabular}
\end{center}
