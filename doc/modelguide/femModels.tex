...
A simple application showing visualization of a {\tt
...
\lstinputlisting[firstline=1,lastline=51]{../../src/artisynth/demos/tutorial/ScalarFieldVisualization.java}
\lstset{firstnumber={1}}
\else
\lstinputlisting[firstline=26,lastline=76]{../../src/artisynth/demos/tutorial/ScalarFieldVisualization.java}
\fi
\lstset{numbers=none}
%
