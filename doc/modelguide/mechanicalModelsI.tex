...
\begin{gather*}
\K_{f} \equiv 
\matl k_{fx} & 0 & 0 \\ 0 & k_{fy} & 0 \\ 0 & 0 & k_{fz} \matr, \;
\D_{f} \equiv 
\matl d_{fx} & 0 & 0 \\ 0 & d_{fy} & 0 \\ 0 & 0 & d_{fz} \matr, \;\\
\K_{\tau} \equiv
\matl k_{\tau x} & 0 & 0 \\ 0 & k_{\tau y} & 0 \\ 0 & 0 & k_{\tau z} \matr, \;
\D_{\tau} \equiv
\matl d_{\tau x} & 0 & 0 \\ 0 & d_{\tau y} & 0 \\ 0 & 0 & d_{\tau z} \matr.
\end{gather*}
%
are the stiffness and damping matrices. The stiffness and damping
values $\k_f$, $\k_\tau$, $\d_f$, and $\d_\tau$ are exposed as the
...
\end{verbatim}
%
and most of the code for this is shown below:
%
\begin{lstlisting}
