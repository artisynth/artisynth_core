...
restoring forces to help keep the joint within presribed bounds.
...
directly, but instead create them implicitly using the followng {\tt
MechModel} methods:
%
\begin{lstlisting}[]
