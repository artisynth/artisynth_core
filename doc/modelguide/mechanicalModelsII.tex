...
component that arises in responce to the excitation signal.
...
rigid bodies, and finally reenable collisions between all bodies with
...
explicity using the {\tt MechModel} methods
%
\begin{lstlisting}[]
