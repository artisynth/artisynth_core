...
tediuous to access individually. (The collective visibility
...
{Set the springs's wrappables to be visible or invisible.}%
%
\midline
\end{methodtable}
%
...
the GUI by selecting the muscle and then choosing {\sf Show wrappbles} or {\sf
Hide wrappbles} from the context menu.
\end{sideblock}
