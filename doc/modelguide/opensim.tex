...
\lstinputlisting[firstline=1]{../../src/artisynth/demos/opensim/OpenSimFemElbow.java}
\lstset{firstnumber={1}}
\else
\lstinputlisting[firstline=28]{../../src/artisynth/demos/opensim/OpenSimFemElbow.java}
\fi
\lstset{numbers=none}
...
The {\tt build()} method for {\tt OpenSimFemHumerus} makes use of the following
helper methods:
%
\lstset{numbers=left} 
\iflatexml
...
\lstinputlisting[firstline=131,lastline=180]{../../src/artisynth/demos/opensim/OpenSimFemHumerus.java}
%\lstset{firstnumber={1}}
\else
...
%% Hack: latexml lstinputlisting doesn't handle firstline correctly
%\lstset{firstnumber={-25}}
\lstinputlisting[firstline=40,lastline=128]{../../src/artisynth/demos/opensim/OpenSimFemHumerus.java}
%\lstset{firstnumber={1}}
\else
