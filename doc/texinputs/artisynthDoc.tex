...
\def\dohashtodot#1#2\wholeString{\if#1$%
...
\href{@JDOCBEGIN/\concatnames{}{#1}{#2}@JDOCEND}{\hashtodot{#2}}}
\newcommand{\javaclassAlt}[2]{%
\href{@JDOCBEGIN/\concatnames{}{}{#1}@JDOCEND}{\hashtodot{#2}}}
...
\newcommand{\javaclass}[2][]{{\color{darkblue}\hashtodot{#2}}}
\newcommand{\javaclassAlt}[2]{{\color{darkblue}\hashtodot{#2}}}
%\href{\javaurl\dottoslash{\concatnames{\javabase}{#1}{#2}}.html}{#2}}
