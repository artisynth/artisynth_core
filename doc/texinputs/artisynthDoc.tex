...
% methodtablewidth:
% 
% arg #1: width of the method signature column, in percent
% arg #2: width of the method comment column, in percent
%
% arg #1 and arg %2 should sum to 1. Typical default values are 0.5 and 0.5, or
% 0.6 and 0.4 if more space is needed for the method signature column needs to
% be longer. In some cases, if a lot of space is needed by the signature
% column, comments are left blank and #1 and #2 are set to something like 0.95
% and 0.05.
...
% command called within the methodtable environment to add a method to a method
% table:
%
% arg #1: package and method signature. This should be the full package name,
% method name and signature.
% arg #2: anchor text
% arg #3: short comment describing the method
%
% Typical usage looks likes this:
%
...
% adds a top line within a methodtable environment
\newcommand{\topline}{\iflatexml\hline\else\toprule\fi}
% adds a middle line within a methodtable environment
\newcommand{\midline}{\iflatexml\hline\else\midrule\fi}
% adds a bottom line within a methodtable environment
\newcommand{\botline}{\iflatexml\hline\else\bottomrule\fi}
\newcommand{\blankline}{%
\multicolumn{2}{l}{\iflatexml{@SPACE}\else\phantom{M}\fi}\\}%
% add a vertical space within a methodtable environment
...
% break a line and add an indentation of 1em, within either the anchor text or
% comment section (arguments #2 or #3) of a \methodentry call. This is used to
