...
\def\dodollartodot#1#2\wholeString{\if#1!%
\else\if#1\${.}\else{#1}\fi\dollartaketherest#2\fi}
...
\newcommand{\javaclass}[2][]{{\color{darkblue}\dollartodot{#2}}}
\newcommand{\javaclassAlt}[2]{{\color{darkblue}{#2}}}
%\href{\javaurl\dottoslash{\concatnames{\javabase}{#1}{#2}}.html}{#2}}
