...
\author{John Lloyd}
\setpubdate{Last update: Nov 23, 2017}
\iflatexml
\date{}
\fi
...
Mouse bindings can also be explicitly set by the user, by openning the
...
middle mouse buttons.  Actions marked with an asterix (*) are drag
...
\hline
{\tt q} & quit ArtiSynth \\
{\tt t} & toggle time line visiblity \\
...
Reset the manipulator frame to the orginal local frame for the
