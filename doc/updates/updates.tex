...
% \subsection*{MAPStress and MAPStrain added to FemModel.SurfaceRender}
...
analagous to {\tt MuscleBundle}, except that they can be used for any
...
\begin{lstlisting}[]
  ...
  // creates an object for storing the stae
...
added to an FEM model in a manner analagous to {\tt MaterialBundle}.
