...
\javaclass{ComponentListImpl} is available as an internal
implementation class for constructing instances of either
\javaclass{CompositeComponent} or
\javaclass{MutableCompositeComponent} (the latter is a composite
...
A special type of component, \javaclass{ReferenceComponent}, has been
created, which simply provides a reference to another component.  This
is used to implement \javaclass{ReferenceList}, which provides a
