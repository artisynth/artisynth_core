...
This update entails changes to the API. For application code that does
not explicitly implement component {\tt render()} methods or
...
further changes described under {\it API changes involving the
...
The renaming is summarized in the following table:
...
\hline
\multicolumn{2}{l}{Renamed enum fields}\\
\hline
...
API changes involving the viewer take the form of class renaming
and method refactorization, including moving some classes into the
subpackage {\tt render.GL}, as decribed below:
