 ...
 * constructor.
 */
public class MatrixNdVertexField extends VectorVertexField<MatrixNd> {
  ...
  /**
    ...
    */   
   public MatrixNdVertexField (int rowSize, int colSize, MeshComponent mcomp) {
