 ...
 */
public class ConstraintForceTarget extends RenderableComponentBase
   ...
   public static PropertyList myProps =
      new PropertyList (ConstraintForceTarget.class, RenderableComponentBase.class);
   ...
   public void setConnector (BodyConnector connector) {
      if (connector instanceof PlanarConnector ||
         ...
         initializeSubWeights (connector.numBilateralConstraints());
      }
      else {
         throw new IllegalArgumentException (
