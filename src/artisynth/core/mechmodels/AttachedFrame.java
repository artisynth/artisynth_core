...
/**
 * Abstract base class for a Frame that is attached to another component,
 * in the same way that Marker is a Point attached to another component.
 */
public abstract class AttachedFrame extends Frame
