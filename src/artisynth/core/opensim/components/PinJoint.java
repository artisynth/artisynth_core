...
public class PinJoint extends JointBase {
   ...
   public artisynth.core.mechmodels.JointBase createJoint (RigidBody parent, RigidBody child) {
      ...
      // build joint
      if (getReverse ()) {
         rj = new RevoluteJoint ( child, getJointTransformInChild(), parent, getJointTransformInParent());
      } else {
         rj = new RevoluteJoint (parent, getJointTransformInParent(), child, getJointTransformInChild());
      }
