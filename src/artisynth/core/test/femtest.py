...
fem.setSoftIncompMethod (FemModel3d.IncompMethod.FULL)
runTest ("HexBlock SoftIncomp=FULL", 0.3, dataFileName)
fem.setIncompressible (FemModel3d.IncompMethod.NODAL)
fem.setMaterial (MooneyRivlinMaterial(2000, 0, 0, 0, 0, 50000))
...
loadModel ("artisynth.demos.fem.HexCube", "-quad")
fem = find ("models/mech/models/hex")
fem.setUseConsistentMass (True)
runTest ("QuadHexBlock SoftIncomp=ELEMENT", 0.2, dataFileName)
fem.setSoftIncompMethod (FemModel3d.IncompMethod.NODAL)
runTest ("QuadHexBlock SoftIncomp=NODAL", 0.2, dataFileName)
fem.setSoftIncompMethod (FemModel3d.IncompMethod.FULL)
runTest ("QuadHexBlock SoftIncomp=FULL", 0.2, dataFileName)
fem.setIncompressible (FemModel3d.IncompMethod.NODAL)
fem.setMaterial (MooneyRivlinMaterial(2000, 0, 0, 0, 0, 50000))
runTest ("QuadHexBlock HardIncomp=NODAL", 0.2, dataFileName)
fem.setIncompressible (FemModel3d.IncompMethod.NODAL)
fem.setMaterial (LinearMaterial (5000, 0.33))
runTest ("QuadHexBlock HardIncomp=NODAL Linear", 0.2, dataFileName)
fem.setIncompressible (FemModel3d.IncompMethod.ELEMENT)
fem.setMaterial (MooneyRivlinMaterial(2000, 0, 0, 0, 0, 50000))
runTest ("QuadHexBlock HardIncomp=ELEMENT", 0.2, dataFileName)
fem.setIncompressible (FemModel3d.IncompMethod.ELEMENT)
fem.setMaterial (LinearMaterial (5000, 0.33))
runTest ("QuadHexBlock HardIncomp=ELEMENT Linear", 0.2, dataFileName)
...
# Quad and other elements tests

loadModel ("artisynth.demos.fem.QuadtetBeam3d")
fem = getFemModel()
fem.setMaterial (LinearMaterial())
runTest ("QuadtetBeam3d linear", 0.5, dataFileName)
fem.setMaterial (StVenantKirchoffMaterial())
runTest ("QuadtetBeam3d StVenantKirchoff", 0.5, dataFileName)
fem.setMaterial (IncompNeoHookeanMaterial())
runTest ("QuadtetBeam3d IncompNeoHookean", 0.5, dataFileName)

loadModel ("artisynth.demos.fem.QuadwedgeBeam3d")
fem = getFemModel()
fem.setMaterial (LinearMaterial())
runTest ("QuadwedgeBeam3d linear", 0.5, dataFileName)
fem.setMaterial (OgdenMaterial())
runTest ("QuadwedgeBeam3d Ogden", 0.5, dataFileName)
mat = FungOrthotropicMaterial(1e4,2e4,3e4,1e4,2e4,3e4,2e3,2e3,2e3,1500,1e6)
fem.setMaterial (mat)
runTest ("QuadwedgeBeam3d FungOrthotropic", 0.5, dataFileName)

loadModel ("artisynth.demos.fem.QuadpyramidBeam3d")
fem = getFemModel()
fem.setMaterial (LinearMaterial())
runTest ("QuadpyramidBeam3d linear", 0.5, dataFileName)
fem.setMaterial (ArrudaBoyceMaterial())
runTest ("QuadpyramidBeam3d ArrudaBoyce", 0.5, dataFileName)
fem.setMaterial (TransverseLinearMaterial())
runTest ("QuadpyramidBeam3d TransverseLinear", 0.5, dataFileName)

loadModel ("artisynth.demos.fem.WedgeBeam3d")
fem = getFemModel()
fem.setMaterial (LinearMaterial())
runTest ("WedgeBeam3d linear", 0.5, dataFileName)
fem.setMaterial (VerondaWestmannMaterial())
runTest ("WedgeBeam3d VerondaWestmann", 0.5, dataFileName)

loadModel ("artisynth.demos.fem.PyramidBeam3d")
fem = getFemModel()
fem.setMaterial (LinearMaterial())
runTest ("PyramidBeam3d linear", 0.5, dataFileName)
fem.setMaterial (YeohMaterial())
runTest ("PyramidBeam3d Yeoh", 0.5, dataFileName)
