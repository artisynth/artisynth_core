...
public class AttachedBeamDemo extends RootModel {
   ...
   public void build (String[] args) {
      ...
      Particle p1 = new Particle ("p1", 20, 1.5,  0.25, 0.25);
      Particle p2 = new Particle ("p2", 20, 1.5, -0.25, 0.25);
      setPointRenderProps (p1, Color.WHITE);      
      setPointRenderProps (p2, Color.WHITE);
      mechMod.addParticle (p1);
      mechMod.addParticle (p2);
      AxialSpring spring1 = createSpring ("spring1");
      AxialSpring spring2 = createSpring ("spring2");
      mechMod.attachAxialSpring (anchor1, p1, spring1);
      mechMod.attachAxialSpring (anchor2, p2, spring2);

      FemNode3d n1 = beam1.getNodes().getByNumber(26);
      FemNode3d n2 = beam1.getNodes().getByNumber(20);
      n1.setName ("n1");
      n2.setName ("n2");
      mechMod.attachPoint (p1, n1);
      mechMod.attachPoint (p2, n2);
