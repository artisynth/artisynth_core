 ...
 */
public class ShellQuadPatch extends RootModel {
   ...
   protected void build_modelStructure (boolean membrane) {
      ...
      // vertices.
      myMesh = MeshFactory.createQuadRectangle (
         myMeshX, myMeshY, myMeshXDiv, myMeshYDiv);
      ...
      for (Face face : myMesh.getFaces()) {
         ...
         // face...
         Vertex3d[] quadVtx = face.getVertices();
         for (Vertex3d vertex : quadVtx) {
         ...
         FemNode3d n0 = myNodes[ quadVtx[0].getIndex() ];
         FemNode3d n1 = myNodes[ quadVtx[1].getIndex() ];
         FemNode3d n2 = myNodes[ quadVtx[2].getIndex() ];
         FemNode3d n3 = myNodes[ quadVtx[3].getIndex() ];
   ...
   public static PropertyList myProps =
      new PropertyList (ShellQuadPatch.class, RootModel.class);
