...
public class AttachedBeamBody extends RootModel {
   ...
   public void build (String[] args) {
      ...
      mechMod.addFrameMarker (mkr, link2, new Point3d ((lenx1+leny1)/2, 0, 0));
      Particle p1 = new Particle ("part", 10, 4, 0, 5);
      ...
      mechMod.attachAxialSpring (mkr, p1, spr0);
      // spr1.setRenderProps (props);
