...
public class ToySpine extends RootModel {
   ...
   protected double myDensity = 1000.0; // MKS units for this model
   ...
   public void build (String[] args) throws IOException {
      ...
      // create a rigid body for cervical vertebra 2
      myCerv2 = RigidBody.createFromMesh (
         "cerv2", geodir + "cerv2.obj", myDensity, /*scale*/1.0);
      myCerv2.centerPoseOnCenterOfMass(); // center frame on the centroid
      myMech.addRigidBody (myCerv2);
...
//            /*stiffness*/0.1, /*damping*/0, /*maxForce*/0.1));
...
//      addController (controller);
   ...
   RigidBody addBody (String name) {
      ...
      RigidBody body = RigidBody.createFromMesh (
         name, geodir + name + ".obj", myDensity, /*scale*/1.0);
...
//         "spring"+name, 0, /*rotStiffness*/0.001, 0, /*rotDamping*/0.0001);
