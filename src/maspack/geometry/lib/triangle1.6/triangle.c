...
#ifndef POINTER
#warning "defining default POINTER size"
...
#define decode(ptr, otri)                                                     \
  (otri).orient = (int) ((POINTER) (ptr) & (POINTER) 3l);         \
  (otri).tri = (triangle *)                                                   \
                  ((POINTER) (ptr) ^ (POINTER) (otri).orient)
...
#define encode(otri)                                                          \
  (triangle) ((POINTER) (otri).tri | (POINTER) (otri).orient)
...
#define infected(otri)                                                        \
  (((POINTER) (otri).tri[6] & (POINTER) 2l) != 0l)
...
#define sdecode(sptr, osub)                                                   \
  (osub).ssorient = (int) ((POINTER) (sptr) & (POINTER) 1l);      \
  (osub).ss = (subseg *)                                                      \
              ((POINTER) (sptr) & ~ (POINTER) 3l)
...
#define sencode(osub)                                                         \
  (subseg) ((POINTER) (osub).ss | (POINTER) (osub).ssorient)
...

{
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Origin[%d] = x%llx  (%.12g, %.12g)\n",
           (t->orient + 1) % 3 + 3, (POINTER) printvertex,
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Dest  [%d] = x%llx  (%.12g, %.12g)\n",
           (t->orient + 2) % 3 + 3, (POINTER) printvertex,
           printvertex[0], printvertex[1]);
  apex(*t, printvertex);
  if (printvertex == (vertex) NULL)
    printf("    Apex  [%d] = NULL\n", t->orient + 3);
    ...
    printf("    Apex  [%d] = x%llx  (%.12g, %.12g)\n",
           t->orient + 3, (POINTER) printvertex,
           printvertex[0], printvertex[1]);
...

{
  ...
  printf("subsegment x%llx with orientation %d and mark %d:\n",
         (POINTER) s->ss, s->ssorient, mark(*s));
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Origin[%d] = x%llx  (%.12g, %.12g)\n",
           2 + s->ssorient, (POINTER) printvertex,
           printvertex[0], printvertex[1]);
  sdest(*s, printvertex);
  if (printvertex == (vertex) NULL)
    printf("    Dest  [%d] = NULL\n", 3 - s->ssorient);
    ...
    printf("    Dest  [%d] = x%llx  (%.12g, %.12g)\n",
           3 - s->ssorient, (POINTER) printvertex,
           printvertex[0], printvertex[1]);
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Segment origin[%d] = x%llx  (%.12g, %.12g)\n",
           4 + s->ssorient, (POINTER) printvertex,
           printvertex[0], printvertex[1]);
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Segment dest  [%d] = x%llx  (%.12g, %.12g)\n",
           5 - s->ssorient, (POINTER) printvertex,
           printvertex[0], printvertex[1]);
}
...

{
  ...
  alignptr = (POINTER) (pool->nowblock + 1);
  /* Align the item on an `alignbytes'-byte boundary. */
  pool->nextitem = (VOID *)
    (alignptr + (POINTER) pool->alignbytes -
     (alignptr % (POINTER) pool->alignbytes));
...

{
  ...
  alignptr = (POINTER) (pool->pathblock + 1);
...

{
  ...
  alignptr = (POINTER) m->dummytribase;
  m->dummytri = (triangle *)
    (alignptr + (POINTER) m->triangles.alignbytes -
     (alignptr % (POINTER) m->triangles.alignbytes));
  ...
  if (b->usesegments) {
    ...
    alignptr = (POINTER) m->dummysubbase;
    m->dummysub = (subseg *)
      (alignptr + (POINTER) m->subsegs.alignbytes -
       (alignptr % (POINTER) m->subsegs.alignbytes));
...

{
  ...
  alignptr = (POINTER) (getblock + 1);
  foundvertex = (char *) (alignptr + (POINTER) m->vertices.alignbytes -
                          (alignptr % (POINTER) m->vertices.alignbytes));
...
#ifdef ANSI_DECLARATORS
POINTER randomnation(unsigned int choices)
#else /* not ANSI_DECLARATORS */
POINTER long randomnation(choices)
...

{
  ...
  while (totalsamplesleft > 0) {
    ...
    alignptr = (POINTER) (sampleblock + 1);
    firsttri = (char *) (alignptr +
                         (POINTER) m->triangles.alignbytes -
                         (alignptr %
                          (POINTER) m->triangles.alignbytes));
...
#warning "CREATING A MAIN FUNCTION?"
