 ...
 */
public class Matrix3x1Block extends Matrix3x1 implements MatrixBlock {
    ...
    */
   public Matrix3x1Block(Vector3d vec) {
      this();
      set (vec);
   }
    ...
    */
   public Matrix1x3Block createTranspose() {
      Matrix1x3Block M = new Matrix1x3Block();
      M.transpose (this);
      return M;
   }
    ...
    * set to be undefined.
    */
   public Matrix3x1Block clone() {
      Matrix3x1Block blk = (Matrix3x1Block)super.clone();
