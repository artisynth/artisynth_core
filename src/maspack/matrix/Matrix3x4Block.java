 ...
 */
public class Matrix3x4Block extends Matrix3x4 implements MatrixBlock {
    ...
    */
   public Matrix4x3Block createTranspose() {
      Matrix4x3Block M = new Matrix4x3Block();
      M.transpose (this);
      return M;
   }
    ...
    * set to be undefined.
    */
   public Matrix3x4Block clone() {
      Matrix3x4Block blk = (Matrix3x4Block)super.clone();
