 ...
 */
public class Matrix3x6Block extends Matrix3x6 implements MatrixBlock {
   ...
   public void mulAdd (double[] y, int yIdx, double[] x, int xIdx) {
      ...
      y[yIdx + 2] +=
         m20 * x0 + m21 * x1 + m22 * x2 + m23 * x3 + m24 * x4 + m25 * x5;
   }
   ...
   public void mulTransposeAdd (double[] y, int yIdx, double[] x, int xIdx) {
      ...
      y[yIdx + 3] += m03 * x0 + m13 * x1 + m23 * x2;
      y[yIdx + 4] += m04 * x0 + m14 * x1 + m24 * x2;
      y[yIdx + 5] += m05 * x0 + m15 * x1 + m25 * x2;
   }
    ...
    */
   public Matrix6x3Block createTranspose() {
      Matrix6x3Block M = new Matrix6x3Block();
      M.transpose (this);
      return M;
   }
    ...
    * set to be undefined.
    */
   public Matrix3x6Block clone() {
      Matrix3x6Block blk = (Matrix3x6Block)super.clone();
