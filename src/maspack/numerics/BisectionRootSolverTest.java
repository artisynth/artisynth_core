...
public class BisectionRootSolverTest extends RootSolverTestBase {

   void test (
      Function1x1 func, double a, double b, double xchk,
      double eps, double feps) {
      int icnt = BisectionRootSolver.getIterationCount();
      double x = BisectionRootSolver.findRoot (func, a, b, eps, feps);
      icnt = BisectionRootSolver.getIterationCount() - icnt;
   ...
   public void test() {
      Function1x1 fxn = new CubicFxn (1, 0, -2, -5);
      ...
      test (fxn, -6.5, 2.5, 1.780019009641143, 1e-11, 1e-10);
      test (fxn, -6.5, 2.5, 1.780019009641143, 1e-7, 1e-6);
      test (fxn, -6.5, 2.5, 1.780019009641143, 1e-6, 1e-5);
   ...
   public static void main (String[] args) {
      BisectionRootSolverTest tester = new BisectionRootSolverTest();
      tester.runtest();
   }
