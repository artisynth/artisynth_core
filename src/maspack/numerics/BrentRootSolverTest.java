...
public class BrentRootSolverTest extends RootSolverTestBase {

   void test (
      Function1x1 func, double a, double b, double xchk,
      double eps, double feps) {
      int icnt = BrentRootSolver.getIterationCount();
      double x = BrentRootSolver.findRoot (func, a, b, eps, feps);
      icnt = BrentRootSolver.getIterationCount() - icnt;
   ...
   public static void main (String[] args) {
      BrentRootSolverTest tester = new BrentRootSolverTest();
      tester.runtest();
   }
