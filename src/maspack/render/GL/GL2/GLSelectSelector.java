...
import maspack.render.GL.GLSelector;
...
public class GLSelectSelector extends GLSelector {
   ...
   public GLSelectSelector (GL2Viewer viewer) {
      super (viewer);
   ...
   public void setupSelection (GLAutoDrawable drawable) {
      ...
      GL2Viewer gl2Viewer = (GL2Viewer)myViewer;
      GL2 gl = gl2Viewer.getGL2();
   ...
   public void processSelection (GLAutoDrawable drawable) {
      ...
      if (hits > 0) {
         myViewer.setSelected( processHits (hits, selectBuffer) );
      }
      else {
