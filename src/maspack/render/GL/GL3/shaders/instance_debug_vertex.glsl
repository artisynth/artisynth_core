...
void main() {
   ...
   position = vertex_position; // instance_scale * vertex_position + instance_position;
   ...
   dirOut.to_eye = vec3(instance_scale, instance_scale, instance_scale); //instance_position; //-camera_position.xyz;
}