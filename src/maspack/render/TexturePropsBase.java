...
public abstract class TexturePropsBase implements CompositeProperty, Scannable, Clonable {
   ...
   public TexturePropsBase() {
      setDefaultModes();
      setDefaultValues();
   }

   public TexturePropsBase (TexturePropsBase props) {
      this();
      set (props);
   }

   public static PropertyList myProps = new PropertyList (TexturePropsBase.class);
   ...
   public void set (TexturePropsBase props) {
   ...
   public boolean equals (Object obj) {
      if (obj instanceof TexturePropsBase) {
         return equals ((TexturePropsBase)obj);
      }
      else {
         return false;
      }
   ...
   public TexturePropsBase clone() {
      TexturePropsBase props = null;
      try {
         props = (TexturePropsBase)super.clone();
      }
